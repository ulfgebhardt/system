...
class saimod_sys_config extends \SYSTEM\SAI\SaiModule {    
    public static function html_content(){
        ...
        $result .= '<tr>'.'<td>'.\SYSTEM\CONFIG\config_ids::SYS_CONFIG_LANGS.               '</td>'.'<td>'.'\SYSTEM\CONFIG\config_ids::SYS_CONFIG_LANGS'.               '</td>'.'<td>'.implode(',',unserialize(\SYSTEM\CONFIG\config::get(\SYSTEM\CONFIG\config_ids::SYS_CONFIG_LANGS))).                                 '</td>'.'</tr>';
